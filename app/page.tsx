...
import { Github, Linkedin, Twitter, ArrowRight, Briefcase, Presentation, Code, Camera } from "lucide-react"
          ...
          <div className="grid items-end gap-8 lg:grid-cols-[1fr_auto]">
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="animate-fade-in-up animation-delay-200 flex flex-wrap items-center gap-3 sm:gap-4">
                ...
                <Link href="https://x.com/_mehmetsezer" target="_blank" rel="noopener noreferrer" className="text-gray-400 transition-colors hover:text-gray-900 dark:hover:text-gray-50">
              ...
              <div className="animate-fade-in-up animation-delay-300 grid grid-cols-2 gap-3 pt-4">
                <Link href="/experience" className="group relative flex items-center gap-3.5 overflow-hidden rounded-xl border border-blue-100 p-4 transition-all hover:shadow-md dark:border-blue-900/50 dark:hover:border-blue-800">
                  <div className="absolute inset-0 bg-linear-to-br from-blue-50 to-transparent opacity-80 dark:from-blue-950/30 dark:to-transparent" />
                  ...
                  <ArrowRight className="relative h-4 w-4 shrink-0 text-blue-300 transition-transform group-hover:translate-x-0.5 group-hover:text-blue-500 dark:text-blue-700 dark:group-hover:text-blue-400" />
                </Link>
                <Link href="/projects" className="group relative flex items-center gap-3.5 overflow-hidden rounded-xl border border-blue-100 p-4 transition-all hover:shadow-md dark:border-blue-900/50 dark:hover:border-blue-800">
                  <div className="absolute inset-0 bg-linear-to-br from-blue-50 to-transparent opacity-80 dark:from-blue-950/30 dark:to-transparent" />
                  <div className="relative rounded-lg bg-blue-100 p-2.5 transition-colors group-hover:bg-blue-200 dark:bg-blue-900/50 dark:group-hover:bg-blue-800/50">
                ...
                <Link href="/speaking" className="group relative flex items-center gap-3.5 overflow-hidden rounded-xl border border-blue-100 p-4 transition-all hover:shadow-md dark:border-blue-900/50 dark:hover:border-blue-800">
                  <div className="absolute inset-0 bg-linear-to-br from-blue-50 to-transparent opacity-80 dark:from-blue-950/30 dark:to-transparent" />
                  <div className="relative rounded-lg bg-blue-100 p-2.5 transition-colors group-hover:bg-blue-200 dark:bg-blue-900/50 dark:group-hover:bg-blue-800/50">
                ...
                <Link href="/photography" className="group relative flex items-center gap-3.5 overflow-hidden rounded-xl border border-blue-100 p-4 transition-all hover:shadow-md dark:border-blue-900/50 dark:hover:border-blue-800">
                  <div className="absolute inset-0 bg-linear-to-br from-blue-50 to-transparent opacity-80 dark:from-blue-950/30 dark:to-transparent" />
                  <div className="relative rounded-lg bg-blue-100 p-2.5 transition-colors group-hover:bg-blue-200 dark:bg-blue-900/50 dark:group-hover:bg-blue-800/50">
                ...
                return (
                  ...
                  >
                    {article.meta.image ? (
                      ...
                      <div className="h-28 w-full bg-linear-to-br from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 lg:h-32" />
                    )}
